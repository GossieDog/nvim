-- Code for PdfAnnots slightly modified from https://github.com/lervag/vimtex/issues/2294
...
wk.add({
	...
	{
		"<leader>TWr",
		"<cmd>read ~/Documents/SFU-Co-Op/Resume/Eric-Fan-Resume.tex<CR>",
		desc = "Resume Complete",
		mode = "n",
		icon = "󰈙",
	},
	{
